...
/**
 * React component responsible for rendering the book details in a modal.
 * For this component, I made use of the react-modal library to make it
 * easier to manage the modal events and styling.
 */
